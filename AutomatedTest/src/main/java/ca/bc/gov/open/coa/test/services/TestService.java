...
//            File template = new File("AutomatedTest/src/main/resources/SoapUiFile/coa-soapui-project-template.xml");
//            Scanner scanner = new Scanner(template);
//            BufferedWriter writer = new BufferedWriter(new FileWriter("AutomatedTest/src/main/resources/SoapUiFile/coa-soapui-project.xml"));
